...
ShaderProgram* spShifty;
ShaderProgram* spAirplane;
...
void initShaders() {
	...
	spShifty = new ShaderProgram("v_shifty.glsl", NULL, "f_shifty.glsl");
	spAirplane = new ShaderProgram("v_airplane.glsl", NULL, "f_airplane.glsl");
}
